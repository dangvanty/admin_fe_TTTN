...
import { dot, edit, trash } from '#/assets/svg/IconSvg';
import { showAction } from './TableJs';
export default function Table({ dataSource, titleTable, urlHistory, onchangeEdit, onchangeDelete, hidentDot }) {
